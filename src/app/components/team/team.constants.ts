      ...
      social: [
        {
          name: 'twitter',
          icon: 'bi bi-twitter',
          url: 'https://twitter.com/danielgarcia7_',
        },
        {
          name: 'instagram',
          icon: 'bi bi-instagram',
          url: 'https://www.instagram.com/7danielgarcia/',
        },
        {
          name: 'linkedin',
          icon: 'bi bi-linkedin',
          url: 'https://www.linkedin.com/in/daniel-garc%C3%ADa-lanzas-337a491aa/',
        },
      ],
    },
    {
      ...
      social: [
        { name: 'twitter', icon: 'bi bi-twitter', url: '' },
        {
          name: 'instagram',
          icon: 'bi bi-instagram',
          url: 'https://www.instagram.com/irenedelgador97/',
        },
        { name: 'linkedin', icon: 'bi bi-linkedin', url: '' },
        {
          name: 'tiktok',
          icon: 'bi bi-tiktok',
          url: 'https://www.tiktok.com/@irenedelgado97',
        },
      ],
    },
  ];
